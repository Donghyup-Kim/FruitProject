...
<%@ page import="com.amazonaws.services.dynamodbv2.xspec.S" %>
<%
                        ...
                        <div class="divTable greyGridTable">
                            <div class="divTableBody">
                                <div class="divTableRow">
                                    <div class="divTableCell"><b>SEQ</b></div>
                                    <div class="divTableCell"><b>TITLE</b></div>
                                    <div class="divTableCell"><b>TYPE</b></div>
                                    <div class="divTableCell"><b>SELLER</b></div>
                                ...
                                %>
                                <div class="divTableRow">
                                    <div class="divTableCell"><%=rDTO.getPro_seq()%></div>
                                    <div class="divTableCell"><%=rDTO.getPro_title()%></div>
                                    <div class="divTableCell"><%=rDTO.getPro_type()%></div>
                                    <div class="divTableCell"><%=rDTO.getPro_reg_id()%></div>
                                    <div class="divTableCell"><%=rDTO.getPro_value()%></div>
                                    <div class="divTableCell"><a href="/pro_delete?pro_seq=<%=rDTO.getPro_seq()%>">삭제</a> </div>
                                    <div class="divTableCell"><a href="/pro_edit?pro_seq=<%=rDTO.getPro_seq()%>">수정</a> </div>
                                </div>
                                <%}%>
                            </div>
                        </div>
...
<button type="button" class="btn btn-dark" onclick="location.href='/sellwrite'" id="insertbutton" >Insert Product</button>
</div>
