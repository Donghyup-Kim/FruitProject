...
<article>
    <div id="borderDemo">
    <div class="container1" role="main"><h2>상품 등록</h2></div>

        </br>
        <form name="form" id="form" role="form" method="post" action="/productwrite1">
            <div class="mb-3">
            ...
            <div class="filebox bs3-primary preview-image">
                <input class="fileUpload" value="파일선택" disabled="disabled" style="width: 200px;">

                <label for="fileUpload">업로드</label>
                <input type="file" id="fileUpload" name="fileUpload" class="upload-hidden">

            <div class="text">
            <button type="button" class="btn btn-sm btn-primary" onclick="file_upload(this);">상품등록</button>
            </div>
            </div>
        </form>
        </br>
