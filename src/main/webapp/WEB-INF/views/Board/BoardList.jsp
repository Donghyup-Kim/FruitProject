...
<div class="container">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="description">
                <h2 style="margin-bottom: 50px; text-align: center; padding-left: 500px">Review Table</h2>
            </div>

            <div class="divTable minimalistBlack" style="margin-bottom: 50px;">
                <div class="divTableHeading">
                    <div class="divTableRow">
                        <div class="divTableHead">SEQ</div>
                        <div class="divTableHead">TITLE</div>
                        <div class="divTableHead">REGID</div>
                ...
                <div class="divTableBody">
                    <div class="divTableRow">
                        <div class="divTableCell"> <a href="/board/boardInfo?nSeq=<%=rDTO.getBoard_seq()%>"><%=CmmUtil.nvl(rDTO.getBoard_seq())%></a></div>
                        <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getBoard_title())%></div>
                        <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getReg_id())%></div>
                        <div class="divTableCell"><%=CmmUtil.nvl(rDTO.getReg_dt())%></div>
                    </div>
                </div>
                <%
                    }
    ...
    <div class="toolbar">
        <button id="WriteBtn" class="btn btn-primary" style="width: 100px; height: 40px; margin-bottom: 50px" onclick="location.href='/board/boardwrite'">Write</button>
    </div>
</div>
