...
<div id="borderDemo">
    <div class="container" role="main" id="center"><h2 style="text-align: center">게시글 수정</h2></div>
    <div>
        <form name="form" id="form" role="form" action="/board/BoardUpdate1">
            <input type="hidden" name="Board_seq" value="<%=CmmUtil.nvl(request.getParameter("Board_seq")) %>" />
